 ...
 *
 */
package com.antaraksi.pdf.info.wrapper;
...
import com.antaraksi.pdf.info.view.CustomSeek;
...
import com.antaraksi.pdf.info.view.DrawView;
    ...
    public void hideShowEditIcon() {
        if (dc != null && !BookType.PDF.is(dc.getCurrentBook().getPath())) {
            ...
            if (dc != null && passwordProtected) {
                ...
                if (PerpustApp.MUPDF_VERSION == AppsConfig.MUPDF_1_11) {
