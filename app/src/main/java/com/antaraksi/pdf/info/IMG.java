...
public class IMG {
    ...
    public static void clearMemoryCache() {
        Glide.get(PerpustApp.context).clearMemory();
    }
    public static RequestManager with(Context a) {
        if (a instanceof HorizontalViewActivity) {
            ...
            return Glide.with(PerpustApp.context);
        }
    }
    ...
    public static void clearDiscCache() {
        try {
            new Thread() {
                @Override
                public void run() {
                    Glide.get(PerpustApp.context).clearDiskCache();
                }
            }.start();
        } catch (Exception e) {
            LOG.e(e);
    ...
    public static void clearCache(String path) {
        try {
            ...
            //Glide.get(PerpustApp.context).clearMemory();
            //Glide.get(PerpustApp.context).getRegistry()
    ...
    public static void getCoverPage(ImageView img, String path, int width) {
        ...
        Glide.with(PerpustApp.context).asBitmap().load(url).into(img);
    }
