package com.antaraksi.pdf.info.widget;
...
import com.antaraksi.pdf.info.ExtFilter;
...
import com.antaraksi.pdf.info.presentation.BrowserAdapter;
import com.antaraksi.pdf.info.presentation.PathAdapter;
...
public class PrefDialogs {
    ...
    public static void selectFileDialog(final Context a, List<String> browseexts, File path, final com.antaraksi.android.utils.ResultResponse<String> onChoose) {
