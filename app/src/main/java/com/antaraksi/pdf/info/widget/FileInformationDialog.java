...
import com.antaraksi.pdf.info.view.ScaledImageView;
...
import com.antaraksi.ui2.AppDB.SEARCH_IN;
import com.antaraksi.ui2.AppDB.SORT_BY;
...
public class FileInformationDialog {
    ...
    public static void showImage(Activity a, String path) {
        ...
        Glide.with(PerpustApp.context).asBitmap().load(url).into(imageView);
    ...
    public static void showImageHttpPath(Context a, String path) {
        ...
        Glide.with(PerpustApp.context).asBitmap().load(path).into(imageView);
