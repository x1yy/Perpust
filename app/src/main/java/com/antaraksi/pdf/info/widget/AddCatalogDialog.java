...
import com.antaraksi.android.utils.AsyncTasks;
...
public class AddCatalogDialog {
    ...
    public static void showDialog(final Activity a, final Runnable onRefresh, final Entry e, final boolean validate) {
        ...
        if (editAppState != null) {
            ...
            Glide.with(PerpustApp.context).load(line[3]).into(image);
                ...
                asyncTask = new AsyncTask() {
                    ...
                    protected Object doInBackground(Object... params) {
                        ...
                        for (String suffix : suffixes) {
                            ...
                            LOG.d("OPDS-uri", uri);
                            Feed feed = com.antaraksi.opds.OPDS.getFeed(uri, a);
                        ...
                        return com.antaraksi.opds.OPDS.getFeed(feedUrl, a);
                    }
