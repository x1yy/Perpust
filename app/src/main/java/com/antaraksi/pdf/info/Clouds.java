...
import com.antaraksi.pdf.search.activity.msg.MessageSyncUpdateList;
import com.antaraksi.pdf.search.view.AsyncProgressTask;
...
public class Clouds {
    ...
    public static final String PERPUST_SYNC_ONLINE_FOLDER = "/Librera.Cloud";
    ...
    private void syncronizeGet(CloudStorage storage, String syncPath) {
        ...
        try {
            ...
            if (!storage.exists(PERPUST_SYNC_ONLINE_FOLDER)) {
            ...
            List<CloudMetaData> childs = storage.getChildren(PERPUST_SYNC_ONLINE_FOLDER);
        ...
        new AsyncProgressTask<Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                try {
                    ...
                    String extSyncFile = PERPUST_SYNC_ONLINE_FOLDER + "/" + file.getName();
    ...
    private void createLibreraCloudFolder(final CloudStorage cloud) {
        ...
        String extSyncFolder = PERPUST_SYNC_ONLINE_FOLDER;
    ...
    public static boolean showHideCloudImage(ImageView img, String path) {
        ...
        if (path.contains(Clouds.PERPUST_SYNC_ONLINE_FOLDER)) {
            img.setVisibility(View.VISIBLE);
            if (path.contains(BookCSS.PERPUST_CLOUD_DROPBOX) || path.startsWith(Clouds.PREFIX_CLOUD_DROPBOX)) {
                img.setImageResource(R.drawable.dropbox);
            } else if (path.contains(BookCSS.PERPUST_CLOUD_GOOGLEDRIVE) || path.startsWith(Clouds.PREFIX_CLOUD_GDRIVE)) {
                img.setImageResource(R.drawable.gdrive);
            } else if (path.contains(BookCSS.PERPUST_CLOUD_ONEDRIVE) || path.startsWith(Clouds.PREFIX_CLOUD_ONEDRIVE)) {
