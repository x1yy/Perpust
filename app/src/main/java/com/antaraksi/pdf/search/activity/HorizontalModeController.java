...
import com.antaraksi.android.utils.Intents;
...
import com.antaraksi.pdf.search.activity.msg.MessageCenterHorizontally;
...
public abstract class HorizontalModeController extends DocumentController {
    ...
    @Override
    public synchronized void getOutline(final com.antaraksi.android.utils.ResultResponse<List<OutlineLinkWrapper>> outlineResonse, boolean forse) {
        if (codeDocument == null) {
            return;
        }
        if (outline == null) {
    ...
    @Override
    public void doSearch(final String text, final com.antaraksi.android.utils.ResultResponse<Integer> result) {
