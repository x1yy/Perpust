package com.antaraksi.pdf.search.activity;
...
import com.antaraksi.android.utils.Keyboards;
...
import com.antaraksi.android.utils.Vibro;
import com.antaraksi.android.utils.Views;
...
import com.antaraksi.pdf.CopyAsyncTask;
import com.antaraksi.pdf.info.ADS;
import com.antaraksi.pdf.info.Android6;
import com.antaraksi.pdf.info.BookmarksData;
import com.antaraksi.pdf.info.BuildConfig;
import com.antaraksi.pdf.info.DictsHelper;
import com.antaraksi.pdf.info.ExtUtils;
import com.antaraksi.pdf.info.IMG;
import com.antaraksi.pdf.info.OutlineHelper;
import com.antaraksi.pdf.info.OutlineHelper.Info;
import com.antaraksi.pdf.info.PasswordDialog;
import com.antaraksi.pdf.info.R;
import com.antaraksi.pdf.info.TintUtil;
import com.antaraksi.pdf.info.UiSystemUtils;
import com.antaraksi.pdf.info.model.OutlineLinkWrapper;
import com.antaraksi.pdf.info.view.AlertDialogs;
import com.antaraksi.pdf.info.view.AnchorHelper;
import com.antaraksi.pdf.info.view.BookmarkPanel;
import com.antaraksi.pdf.info.view.BrightnessHelper;
import com.antaraksi.pdf.info.view.Dialogs;
import com.antaraksi.pdf.info.view.DialogsPlaylist;
import com.antaraksi.pdf.info.view.DragingDialogs;
import com.antaraksi.pdf.info.view.HorizontallSeekTouchEventListener;
import com.antaraksi.pdf.info.view.HypenPanelHelper;
import com.antaraksi.pdf.info.view.MyPopupMenu;
import com.antaraksi.pdf.info.view.ProgressDraw;
import com.antaraksi.pdf.info.view.UnderlineImageView;
import com.antaraksi.pdf.info.widget.DraggbleTouchListener;
import com.antaraksi.pdf.info.widget.RecentUpates;
import com.antaraksi.pdf.info.widget.ShareDialog;
import com.antaraksi.pdf.info.wrapper.DocumentController;
import com.antaraksi.pdf.info.wrapper.MagicHelper;
import com.antaraksi.pdf.search.activity.msg.FlippingStart;
import com.antaraksi.pdf.search.activity.msg.FlippingStop;
import com.antaraksi.pdf.search.activity.msg.InvalidateMessage;
import com.antaraksi.pdf.search.activity.msg.MessageAutoFit;
import com.antaraksi.pdf.search.activity.msg.MessageEvent;
import com.antaraksi.pdf.search.activity.msg.MessagePageXY;
import com.antaraksi.pdf.search.activity.msg.MessegeBrightness;
import com.antaraksi.pdf.search.view.CloseAppDialog;
import com.antaraksi.pdf.search.view.VerticalViewPager;
import com.antaraksi.sys.ClickUtils;
import com.antaraksi.sys.TempHolder;
import com.antaraksi.tts.MessagePageNumber;
import com.antaraksi.tts.TTSControlsView;
import com.antaraksi.tts.TTSEngine;
import com.antaraksi.tts.TTSNotification;
import com.antaraksi.tts.TTSService;
import com.antaraksi.tts.TtsStatus;
import com.antaraksi.ui2.AdsFragmentActivity;
import com.antaraksi.ui2.AppDB;
import com.antaraksi.ui2.MainTabs2;
import com.antaraksi.ui2.MyContextWrapper;
