...
public class AppState {
    ...
    public static Map<String, String> getDictionaries(String input) {
        ...
        providers.put("KBBI", String.format("https://kbbi.kemdikbud.go.id/entri/%s", text));
        return providers;
    }
    ...
    public void defaults(Context a) {
        ...
        if (!AppsConfig.PERPUST_READER.equals(Apps.getPackageName(a)) && !AppsConfig.PRO_PERPUST_READER.equals(Apps.getPackageName(a))) {
