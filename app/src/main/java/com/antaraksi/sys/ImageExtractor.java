...
import com.antaraksi.ext.CalirbeExtractor;
...
import com.antaraksi.ext.MobiExtract;
import com.antaraksi.ext.OdtExtractor;
import com.antaraksi.ext.RtfExtract;
import com.antaraksi.model.AppSP;
import com.antaraksi.model.AppState;
import com.antaraksi.opds.OPDS;
...
public class ImageExtractor {
    ...
    public InputStream getStreamInner(final String imageUri, String hash) throws IOException {
        ...
        if (imageUri.startsWith(Safe.TXT_SAFE_RUN)) {
            ...
            return PerpustApp.context.getResources().getAssets().open("opds/web.png");
        ...
        if (imageUri.startsWith("assets:")) {
            return PerpustApp.context.getResources().getAssets().open(imageUri.replace("assets://", ""));
        }
