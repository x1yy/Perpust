...
public class TTSNotification {
    ...
    public static Notification show(String bookPath, int page, int maxPages) {
        ...
        try {
            ...
            Glide.with(PerpustApp.context).asBitmap().load(url).into(new NotificationTarget(context, R.id.ttsIcon, remoteViews, n, NOT_ID));
            Glide.with(PerpustApp.context).asBitmap().load(url).into(new NotificationTarget(context, R.id.ttsIcon, remoteViewsSmall, n, NOT_ID));
    ...
    public static void hideNotification() {
        try {
            ...
            NotificationManager nm = (NotificationManager) PerpustApp.context.getSystemService(Context.NOTIFICATION_SERVICE);
            nm.cancel(NOT_ID);
        } catch (Exception e) {
            LOG.e(e);
        }
