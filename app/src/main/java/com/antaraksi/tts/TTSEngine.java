...
import com.antaraksi.mobi.parser.MobiParserIS;
...
public class TTSEngine {
    ...
    OnInitListener listener = new OnInitListener() {
        ...
        public void onInit(int status) {
            ...
            if (status == TextToSpeech.ERROR) {
                Toast.makeText(PerpustApp.context, R.string.msg_unexpected_error, Toast.LENGTH_LONG).show();
            }
    ...
    public TextToSpeech getTTS(OnInitListener onLisnter) {
        ...
        synchronized (helpObject) {
            ...
            ttsEngine = new TextToSpeech(PerpustApp.context, onLisnter);
        }
    ...
    public TextToSpeech setTTSWithEngine(String engine) {
        shutdown();
        synchronized (helpObject) {
            ttsEngine = new TextToSpeech(PerpustApp.context, listener, engine);
        }
        return ttsEngine;
    }
