...
public class SamlibOPDS {
    ...
    public static final String perpust_MOBI = "?from=perpust.mobi";
    ...
    private static List<Entry> getHome() {
        List<Entry> list = new ArrayList<Entry>();
        list.add(new Entry("http://samlib.ru/" + perpust_MOBI, "Переход на сайт", "http://samlib.ru", null));
    ...
    public static Pair<List<Entry>, String> parseBook(String url) {
        ...
        Link link1 = new Link(url + perpust_MOBI, Link.WEB_LINK);
    ...
    public static Entry makeEntry(Element bookItem, Element author) {
        ...
        Link web = new Link(tURL + perpust_MOBI, Link.WEB_LINK, "WEB");
