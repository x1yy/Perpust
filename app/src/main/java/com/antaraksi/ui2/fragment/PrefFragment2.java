package com.antaraksi.ui2.fragment;
...
import com.antaraksi.pdf.info.AndroidWhatsNew;
...
import com.antaraksi.pdf.info.view.KeyCodeDialog;
import com.antaraksi.pdf.info.view.MultyDocSearchDialog;
...
import com.antaraksi.pdf.info.widget.PrefDialogs;
...
import com.antaraksi.pdf.info.wrapper.PasswordState;
import com.antaraksi.pdf.info.wrapper.UITab;
import com.antaraksi.pdf.search.activity.msg.GDriveSycnEvent;
import com.antaraksi.pdf.search.activity.msg.MessageSync;
import com.antaraksi.sys.TempHolder;
import com.antaraksi.ui2.BooksService;
...
public class PrefFragment2 extends UIFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        try {
            ...
            String version = packageInfo.versionName + " (" + PerpustApp.MUPDF_VERSION + ")";
            if (Dips.isEInk()) {
                version += " INK";
            }
