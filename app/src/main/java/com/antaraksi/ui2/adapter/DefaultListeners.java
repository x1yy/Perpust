package com.antaraksi.ui2.adapter;
...
import com.antaraksi.pdf.info.Playlists;
...
import com.antaraksi.pdf.info.view.Downloader;
import com.antaraksi.pdf.info.widget.FileInformationDialog;
...
import com.antaraksi.pdf.search.activity.msg.NotifyAllFragments;
import com.antaraksi.pdf.search.activity.msg.OpenDirMessage;
import com.antaraksi.pdf.search.activity.msg.OpenTagMessage;
    ...
    private static void removeSyncFile(final Activity a, final FileMetaAdapter searchAdapter, final FileMeta result) {
        new AsyncProgressTask<Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                try {
                    String cloudFile = Clouds.PERPUST_SYNC_ONLINE_FOLDER + "/" + ExtUtils.getFileName(result.getPath());
